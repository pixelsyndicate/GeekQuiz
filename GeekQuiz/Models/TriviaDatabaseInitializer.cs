...
{
    /// <summary>
    /// TriviaDatabaseInitializer: the implementation of the Entity Framework initializer for the TriviaContext class 
    /// which inherits from CreateDatabaseIfNotExists. The default behavior of this class is to create the database only 
    /// if it does not exist, inserting the entities specified in the Seed method.
    /// 
    /// ** This is set as the initializer of the EF DB by using SetInitializer in Application_Start **
    /// </summary>
